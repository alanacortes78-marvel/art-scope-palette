    ...
    .map(
      ...
      <article class="artist reveal" data-delay="${(i % 4) + 1}">
        <div class="artist__cover">
          <a href="artista.html?id=${a.id}" aria-label="Entrar al universo de ${a.name}">
        ...
        <div class="artist__body">
          ...
          <h3 class="artist__name"><a href="artista.html?id=${a.id}">${a.name}</a></h3>
          ${a.country ? `<div class="artist__country">${countryFlag(a.country)} ${a.country}${a.age ? " · " + a.age + " años" : ""}</div>` : ""}
